...
namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class DecimalSettings : Neo.ApplicationFramework.Tools.Recipe.Recipe
	{
		...
		private Neo.ApplicationFramework.Tools.Recipe.RecipeItem m_High_sccm_decimal;
		
		private Neo.ApplicationFramework.Tools.Recipe.RecipeItem m_High_slpm_decimal;
		
		private Neo.ApplicationFramework.Tools.Recipe.RecipeItem m_High_scfm_decimal;
		
		private Neo.ApplicationFramework.Tools.Recipe.RecipeItem m_High_scfh_decimal;
		...
		public Neo.ApplicationFramework.Tools.Recipe.RecipeItem High_sccm_decimal
		{
			get
			{
				return this.m_High_sccm_decimal;
			}
			set
			{
				this.m_High_sccm_decimal = value;
			}
		}
		
		public Neo.ApplicationFramework.Tools.Recipe.RecipeItem High_slpm_decimal
		{
			get
			{
				return this.m_High_slpm_decimal;
			}
			set
			{
				this.m_High_slpm_decimal = value;
			}
		}
		
		public Neo.ApplicationFramework.Tools.Recipe.RecipeItem High_scfm_decimal
		{
			get
			{
				return this.m_High_scfm_decimal;
			}
			set
			{
				this.m_High_scfm_decimal = value;
			}
		}
		
		public Neo.ApplicationFramework.Tools.Recipe.RecipeItem High_scfh_decimal
		{
			get
			{
				return this.m_High_scfh_decimal;
			}
			set
			{
				this.m_High_scfh_decimal = value;
			}
		}
		...
		private void InitializeObjectCreations()
		{
			...
			this.High_sccm_decimal = new Neo.ApplicationFramework.Tools.Recipe.RecipeItem();
			this.High_slpm_decimal = new Neo.ApplicationFramework.Tools.Recipe.RecipeItem();
			this.High_scfm_decimal = new Neo.ApplicationFramework.Tools.Recipe.RecipeItem();
			this.High_scfh_decimal = new Neo.ApplicationFramework.Tools.Recipe.RecipeItem();
		}
		...
		private void InitializeObjects()
		{
			...
			this.High_sccm_decimal.ColumnName = "High_sccm_decimal";
			this.High_sccm_decimal.DataConnection = "Tags.HighsccmDecimal";
			this.High_sccm_decimal.Name = "High_sccm_decimal";
			this.High_sccm_decimal.VisualSortOrder = 110;
			this.High_slpm_decimal.ColumnName = "High_slpm_decimal";
			this.High_slpm_decimal.DataConnection = "Tags.HighslpmDecimal";
			this.High_slpm_decimal.Name = "High_slpm_decimal";
			this.High_slpm_decimal.VisualSortOrder = 111;
			this.High_scfm_decimal.ColumnName = "High_scfm_decimal";
			this.High_scfm_decimal.DataConnection = "Tags.HighscfmDecimal";
			this.High_scfm_decimal.Name = "High_scfm_decimal";
			this.High_scfm_decimal.VisualSortOrder = 112;
			this.High_scfh_decimal.ColumnName = "High_scfh_decimal";
			this.High_scfh_decimal.DataConnection = "Tags.HighscfhDecimal";
			this.High_scfh_decimal.Name = "High_scfh_decimal";
			this.High_scfh_decimal.VisualSortOrder = 113;
			...
			this.RecipeItems.Add(this.High_sccm_decimal);
			this.RecipeItems.Add(this.High_slpm_decimal);
			this.RecipeItems.Add(this.High_scfm_decimal);
			this.RecipeItems.Add(this.High_scfh_decimal);
			this.SchemaVersion = ((long)(599));
