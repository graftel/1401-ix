...
namespace Neo.ApplicationFramework.Generated
{
	...
	public partial class Expressions : Neo.ApplicationFramework.Tools.Expressions.ExpressionManager
	{
		...
		{
			return value = Globals.Tags.selMode.Value == 0 ? "Zero\nPressure" : (Globals.Tags.selMode.Value == 1 ? "Zero\nLow" : (Globals.Tags.selMode.Value == 2 ? "Zero\nMid" : "Zero\nHigh"));
		}
		
		public Neo.ApplicationFramework.Interfaces.VariantValue UnitConvsionMid(Neo.ApplicationFramework.Interfaces.VariantValue value)
		{
			return value = Globals.UnitsAndConversion.FlowConv(Globals.Tags.MidRangeMax.Value.Double, Globals.Tags.meter_unit_mid.Value.Int,0);
		}
		
		public Neo.ApplicationFramework.Interfaces.VariantValue UnitConvertHigh(Neo.ApplicationFramework.Interfaces.VariantValue value)
		{
			return value = Globals.UnitsAndConversion.FlowConv(Globals.Tags.HighRangeMax.Value.Double, Globals.Tags.meter_unit_high.Value.Int,0);
		}
		
		public Neo.ApplicationFramework.Interfaces.VariantValue round(Neo.ApplicationFramework.Interfaces.VariantValue value)
		{
			return value;
		}
		
		public Neo.ApplicationFramework.Interfaces.VariantValue UnitConvertLow(Neo.ApplicationFramework.Interfaces.VariantValue value)
		{
			return value = Globals.UnitsAndConversion.FlowConv(Globals.Tags.LowRangeMax.Value.Double, Globals.Tags.meter_unit_low.Value.Int,0);
		}
		
		public Neo.ApplicationFramework.Interfaces.VariantValue PressDecimalFont(Neo.ApplicationFramework.Interfaces.VariantValue value)
		{
			return value = Globals.Tags.MainPressDecimal.Value < 6 ? 43 : 35;
		}
		
		public Neo.ApplicationFramework.Interfaces.VariantValue calSelConv(Neo.ApplicationFramework.Interfaces.VariantValue value)
		{
			return value = Globals.Tags.calSelMeter.Value < 3 ? 1 : 0;
		}
