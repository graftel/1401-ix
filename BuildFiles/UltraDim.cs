...
namespace Neo.ApplicationFramework.Generated {
    ...
    public partial class UltraDim : Neo.ApplicationFramework.Controls.Controls.Form {
        ...
        private bool m_Initialized_UltraDim;
        ...
        private void InitializeComponent() {
            ...
            this.m_AnalogNumeric.ScreenOwnerName = "UltraDim";
            this.m_AnalogNumeric.Top = 104;
            this.m_AnalogNumeric.VisibleDynamicsValue = true;
            this.m_AnalogNumeric.Width = 199;
            // 
            // m_Text1
            // 
            ...
            this.m_Text1.Left = 99;
            this.m_Text1.Name = "m_Text1";
            this.m_Text1.ScreenOwnerName = "UltraDim";
            this.m_Text1.Top = 57;
            ...
            this.m_Button2.Top = 51;
            this.m_Button2.Value = 0D;
            this.m_Button2.VisibleDynamicsValue = true;
            this.m_Button2.VisualPropertiesHashCode = 700834693;
            this.m_Button2.Width = 115;
            // 
            // m_Button3
            // 
            ...
            this.m_Button3.Top = 119;
            this.m_Button3.Value = 0D;
            this.m_Button3.VisibleDynamicsValue = true;
            this.m_Button3.VisualPropertiesHashCode = 700834693;
            ...
            this.m_Button5.VisualPropertiesHashCode = 700834693;
            ...
            this.m_Button8.FontSizePixels = 36;
            this.m_Button8.ForceTransparency = true;
            this.m_Button8.Height = 72;
            this.m_Button8.IndicatorMargin = null;
            this.m_Button8.Left = 340;
            this.m_Button8.Name = "m_Button8";
            this.m_Button8.RequiresTransparency = true;
            this.m_Button8.ScreenOwnerName = "UltraDim";
            this.m_Button8.SymbolIntervalMapper = symbolintervalmapper9;
            this.m_Button8.TextHeight = 43;
            this.m_Button8.TextValue = 0D;
            this.m_Button8.TextWidth = 417;
            this.m_Button8.Top = 393;
            this.m_Button8.Value = 0D;
            this.m_Button8.VisibleDynamicsValue = true;
            this.m_Button8.VisualPropertiesHashCode = -1082900290;
            this.m_Button8.Width = 427;
            // 
            // m_Button9
            // 
            this.m_Button9.Background = new Neo.ApplicationFramework.Common.Graphics.Logic.BrushCF(System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(255)))), ((int)(((byte)(255))))), System.Drawing.Color.FromArgb(((int)(((byte)(212)))), ((int)(((byte)(208)))), ((int)(((byte)(200))))), Neo.ApplicationFramework.Interfaces.FillDirection.VerticalTopToBottom);
            ...
            this.m_Initialized_UltraDim = true;
        ...
        private void m_Button_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button", "Click", "Run", "", "");
            Core.Api.Service.ServiceContainerCF.GetService<Neo.ApplicationFramework.Interfaces.IRunService>().Run("\\FlashDrive\\Project\\Project Files\\RegEditCE.exe", "\\FlashDrive\\Project\\Project Files\\Original.reg");
        }
        
        private void m_Button1_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button1", "Click", "Run", "", "");
            Core.Api.Service.ServiceContainerCF.GetService<Neo.ApplicationFramework.Interfaces.IRunService>().Run("\\FlashDrive\\Project\\Project Files\\RegEditCE.exe", "\\FlashDrive\\Project\\Project Files\\UltraDim.reg");
        }
        
        private void m_Button2_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button2", "Click", "Increment Analog", "Tags.SystemTagBacklightBrightnessLevel", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.SystemTagBacklightBrightnessLevel.IncrementAnalog(5);
        }
        
        private void m_Button3_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button3", "Click", "Decrement Analog", "Tags.SystemTagBacklightBrightnessLevel", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.SystemTagBacklightBrightnessLevel.DecrementAnalog(5);
        }
        
        private void m_Button4_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button4", "Click", "Increment Analog", "Tags.SystemTagBacklightBrightnessLevel", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.SystemTagBacklightBrightnessLevel.IncrementAnalog(1);
        }
        
        private void m_Button5_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button5", "Click", "Decrement Analog", "Tags.SystemTagBacklightBrightnessLevel", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.SystemTagBacklightBrightnessLevel.DecrementAnalog(1);
        }
        
        private void m_Button6_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button6", "Click", "Increment Analog", "Tags.SystemTagBacklightBrightnessLevel", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.SystemTagBacklightBrightnessLevel.IncrementAnalog(20);
        }
        
        private void m_Button7_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button7", "Click", "Decrement Analog", "Tags.SystemTagBacklightBrightnessLevel", "");
            Neo.ApplicationFramework.Generated.Globals.Tags.SystemTagBacklightBrightnessLevel.DecrementAnalog(20);
        }
        
        private void m_Button8_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button8", "Click", "Run", "", "");
            Core.Api.Service.ServiceContainerCF.GetService<Neo.ApplicationFramework.Interfaces.IRunService>().Run("\\FlashDrive\\Project\\Project Files\\SaveReg.exe", "");
        }
        
        private void m_Button9_Action_Click(object sender, System.EventArgs e) {
            Neo.ApplicationFramework.Generated.Globals.AuditTrailService.LogAction("m_Button9", "Click", "Show Screen", "StartScreen", "");
            Neo.ApplicationFramework.Generated.Globals.StartScreen.Show();
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Never)]
        private void ApplyLanguageInternal() {
            Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager resources = new Neo.ApplicationFramework.Tools.MultiLanguage.MultiLanguageResourceManager(typeof(UltraDim));
            this.m_Button.Text = resources.GetText("UltraDim.Button.Text", "Restore to Default");
            this.m_Button1.Text = resources.GetText("UltraDim.Button1.Text", "Change to UltraDim");
            this.m_Text1.Text = resources.GetText("UltraDim.Text1.Text", "Backlight");
            this.m_Button2.Text = resources.GetText("UltraDim.Button2.Text", "+5");
            this.m_Button3.Text = resources.GetText("UltraDim.Button3.Text", "-5");
            this.m_Button4.Text = resources.GetText("UltraDim.Button4.Text", "+1");
            this.m_Button5.Text = resources.GetText("UltraDim.Button5.Text", "-1");
            this.m_Button6.Text = resources.GetText("UltraDim.Button6.Text", "+20");
            this.m_Button7.Text = resources.GetText("UltraDim.Button7.Text", "-20");
            this.m_Button8.Text = resources.GetText("UltraDim.Button8.Text", "Save Settings");
            this.m_Button9.Text = resources.GetText("UltraDim.Button9.Text", "Back");
